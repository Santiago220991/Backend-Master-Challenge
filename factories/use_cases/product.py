...
from app.src.use_cases import ListProducts, FindProductById, CreateProduct, DeleteProductById
...
def delete_product_use_case() -> DeleteProductById:
    return DeleteProductById(get_product_repository())
